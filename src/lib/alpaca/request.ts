...
export const alpacaGetPortfolioHistory = (): Promise<Result<AlpacaPortfolioHistory>> => {
...
export const alpacaGetQuoteHistory = (
	...
	return alpacaSendRequest(
		`stocks/${symbol}/quotes?start=${formatAlpacaDate(start)}&end=${formatAlpacaDate(
			end
		)}&limit=1000`,
		'data'
	);
...
export const alpacaGetTradeHistory = (
	...
	return alpacaSendRequest(
		`stocks/${symbol}/trades?start=${formatAlpacaDate(start)}&end=${formatAlpacaDate(
			end
		)}&limit=10000`,
		'data'
	);
...
export const alpacaGetBarsHistory = (
	...
	return alpacaSendRequest(
		`stocks/${symbol}/bars?start=${formatAlpacaDate(start)}&end=${formatAlpacaDate(
			end
